...
function Register() {
  ...
  return (
    <Base>
      <div className="bg-base-100 w-full flex flex-col min-h-screen items-center justify-center">
        {alert && (
          <div
            role="alert"
            className={`alert ${
              error ? "alert-error" : "alert-success"
            } absolute top-0 mt-20 max-w-sm`}
          >
            <svg
        ...
        <div className="w-full flex items-center justify-center mt-24 pb-5">
          <div className="flex items-center justify-center py-10 flex-col w-full max-w-lg border-2 border-white rounded-md">
            ...
            <div className="w-full px-10">
              <form onSubmit={handleSubmit}>
                ...
                <label className="form-control w-full">
                  <div className="label">
                    <span className="label-text">What is your fullname?</span>
                  </div>
                  <input
                    type="text"
                    name="fullname"
